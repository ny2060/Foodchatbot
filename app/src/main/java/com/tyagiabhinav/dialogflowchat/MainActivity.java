...
public class MainActivity extends AppCompatActivity {
    ...
    private String api="AIzaSyDsipnWuL0wfclEAf7Auk0m3P6u-GVOTgk";
...
//        initChatbot();
    ...
    private void initChatbot() {
        final AIConfiguration config = new AIConfiguration(api, AIConfiguration.SupportedLanguages.Korean,
    ...
    private void initV2Chatbot() {
        try {
            InputStream stream = getResources().openRawResource(R.raw.nayoung);
